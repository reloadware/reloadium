...
public final class Const {
    ...
    public final String version = "0.8.3";  //  # RwRender: public final String version = "{{ ctx.version }}";  //
    ...
    public final String configFilename = "config-local.json";  //  # RwRender: public final String configFilename = "{{ ctx.product.db.filename }}";  //

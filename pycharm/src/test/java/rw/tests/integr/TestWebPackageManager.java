...
public class TestWebPackageManager extends BaseMockedTestCase {
    ...
    public void testGetAllWheels() throws Exception {
        ...
        assertThat(wheel2.getArchitecture()).isEqualTo(Architecture.X64);
        ...
        assertThat(wheel3.getArchitecture()).isEqualTo(Architecture.X64);
        ...
        assertThat(wheel5.getArchitecture()).isEqualTo(Architecture.X64);
        ...
        assertThat(wheel6.getArchitecture()).isEqualTo(Architecture.X64);
        ...
        assertThat(wheel7.getArchitecture()).isEqualTo(Architecture.X64);
        ...
        assertThat(wheel8.getArchitecture()).isEqualTo(Architecture.X64);

...
from reloadium.vendored.sentry_sdk._functools import wraps
from reloadium.vendored.sentry_sdk._types import MYPY
from reloadium.vendored.sentry_sdk.utils import logger, capture_internal_exceptions
from reloadium.vendored.sentry_sdk.tracing import Transaction
from reloadium.vendored.sentry_sdk.attachments import Attachment
...
if MYPY:
    ...
    from reloadium.vendored.sentry_sdk.tracing import Span

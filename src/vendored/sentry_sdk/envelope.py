...
from reloadium.vendored.sentry_sdk._compat import text_type
from reloadium.vendored.sentry_sdk._types import MYPY
from reloadium.vendored.sentry_sdk.session import Session
from reloadium.vendored.sentry_sdk.utils import json_dumps, capture_internal_exceptions
...
if MYPY:
    ...
    from reloadium.vendored.sentry_sdk._types import Event, EventDataCategory

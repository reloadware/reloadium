...
from reloadium.vendored.watchdog.utils import BaseThread
from reloadium.vendored.watchdog.utils.bricks import SkipRepeatsQueue
...
class ObservedWatch:
    ...
    def __repr__(self):
        return "<%s: path=%s, is_recursive=%s>" % (type(self).__name__, self.path, self.is_recursive)

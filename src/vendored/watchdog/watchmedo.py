...
from reloadium.vendored.watchdog.version import VERSION_STRING
from reloadium.vendored.watchdog.utils import WatchdogShutdown, load_class
...
def tricks_from(args):
    ...
    if args.debug_force_polling:
        from reloadium.vendored.watchdog.observers.polling import PollingObserver as Observer
    elif args.debug_force_kqueue:
        from reloadium.vendored.watchdog.observers.kqueue import KqueueObserver as Observer
    elif args.debug_force_winapi_async:
        from reloadium.vendored.watchdog.observers.read_directory_changes_async import\
            WindowsApiAsyncObserver as Observer
    elif args.debug_force_winapi:
        from reloadium.vendored.watchdog.observers.read_directory_changes import\
            WindowsApiObserver as Observer
    elif args.debug_force_inotify:
        from reloadium.vendored.watchdog.observers.inotify import InotifyObserver as Observer
    elif args.debug_force_fsevents:
        from reloadium.vendored.watchdog.observers.fsevents import FSEventsObserver as Observer
    else:
        # Automatically picks the most appropriate observer for the platform
        # on which it is running.
        from reloadium.vendored.watchdog.observers import Observer
...
def log(args):
    ...
    :param args:
        Command line argument options.
    """
    from reloadium.vendored.watchdog.utils import echo
    from reloadium.vendored.watchdog.tricks import LoggerTrick
...
def shell_command(args):
    ...
    :param args:
        Command line argument options.
    """
    from reloadium.vendored.watchdog.tricks import ShellCommandTrick
...
def auto_restart(args):
    ...
    from reloadium.vendored.watchdog.tricks import AutoRestartTrick
    import signal

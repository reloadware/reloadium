...
from reloadium.vendored.watchdog.utils.dirsnapshot import DirectorySnapshot, DirectorySnapshotDiff
from reloadium.vendored.watchdog.observers.api import EventEmitter, BaseObserver, DEFAULT_OBSERVER_TIMEOUT, DEFAULT_EMITTER_TIMEOUT

from reloadium.vendored.watchdog.events import (
    DirMovedEvent,
    DirDeletedEvent,
    DirCreatedEvent,
    DirModifiedEvent,
...
class PollingEmitter(EventEmitter):
    ...
    def __init__(self, event_queue, watch, timeout=DEFAULT_EMITTER_TIMEOUT, stat=os.stat, listdir=os.scandir):
